...
<html>
    <head>
        ...
        <style>
            ...
            /* Table Styling from Mentor Page */
            ...
            select { 
                padding: 8px; background: #3d4648; border: 1px solid #555; color: white; border-radius: 4px; width: 100%;
            }
    ...
    <body>
        <div class="navbar">
            ...
            <div style="display: flex; gap: 15px; align-items: center;">
                <a href="adminDashboard.jsp" style="color: white; text-decoration: none;">Back</a>
            ...
            <div style="display: flex; gap: 10px; margin-bottom: 20px; align-items: center;">
                ...
                <form action="${pageContext.request.contextPath}/ListMenteeServlet" method="GET" style="display: flex; gap: 5px;">
                    <select name="filterMentorID" onchange="this.form.submit()" 
                            style="width: 200px; padding: 8px; background: #3d4648; border: 1px solid #555; color: white; border-radius: 4px;">
                ...
                <form action="${pageContext.request.contextPath}/ListMenteeServlet" method="GET">
                    ...
                    <button type="submit" class="btn-submit" style="background-color: #f39c12; padding: 8px 15px;">
                        Sort by: 
                        <c:choose>
                ...
                <a href="${pageContext.request.contextPath}/ListMenteeServlet" 
                   style="color: #b2bec3; text-decoration: none; font-size: 14px; margin-left: 10px;">Reset Filters</a>
            </div>
            <table>
                <thead>
                    <tr>
                                    ...
                                    <select name="mentorID">
                                        ...
                                        <c:forEach var="mentor" items="${mentorList}">
                                            <option value="${mentor.mentorID}" ${mentor.mentorID == mentee.mentorID ? 'selected' : ''}>
                                                ${mentor.mentorFullname} (${mentor.mentorFaculty})
                                            </option>
                                        </c:forEach>
                                    </select>
